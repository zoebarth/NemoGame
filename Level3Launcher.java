...
/**
 *Launches level 3 for after you finish level 2 or die on level 3
 */
public class Level3Launcher extends JFrame implements MouseListener
{
	...
	/**
	 *Creates a JFrame to start level3
	 */
    public Level3Launcher() 
    {
    setSize(900,600);
		setResizable(false);
		setTitle("Level 3");
		...
		levelLabel = new JLabel("LEVEL 3", SwingConstants.CENTER);
